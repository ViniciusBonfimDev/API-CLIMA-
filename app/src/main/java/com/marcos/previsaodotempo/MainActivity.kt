...
class MainActivity : AppCompatActivity() {
    ...
    private fun respostaServidor(response: Response<Main>){
        ...
        if (country.equals("BR")){
            pais = "Brasil"
            binding.imgClima.setBackgroundResource(R.drawable.brasil)
            binding.containerPrincipal.setBackgroundColor(Color.parseColor("#32CD32"))
        }else if (country.equals("US")){
            pais = "Estados Unidos"
            binding.imgClima.setBackgroundResource(R.drawable.usa)
            binding.containerPrincipal.setBackgroundColor(Color.parseColor("#0000ff"))
        }
        else if  (country.equals("ES")){
            pais = "Espanha"
            binding.imgClima.setBackgroundResource(R.drawable.espanha)
            binding.containerPrincipal.setBackgroundColor(Color.parseColor("#ff6400"))
        } else if  (country.equals("PT")){
            pais = "Portugal"
            binding.imgClima.setBackgroundResource(R.drawable.portugal)
            binding.containerPrincipal.setBackgroundColor(Color.parseColor("#556b2f"))
        } else {
            binding.containerPrincipal.setBackgroundColor(Color.parseColor("#396BCB"))
        }
